...
[_QWERTY] = LAYOUT_planck_grid(
  ...
  KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_LSFT, KC_LSFT, KC_SPC,  KC_SPC,  RAISE,  EXTRAS,   WIN_L,  WIN_R
),
...
[_ADJUST] = LAYOUT_planck_grid(
  ...
  MU_MOD, _______,  _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX, XXXXXXX
),
